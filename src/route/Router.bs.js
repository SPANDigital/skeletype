...
import * as Config$ReasonScripts from "./Config.bs.js";
...
function make(children) {
  return /* record */[
          ...
          /* initialState */(function () {
              return /* record */[/* currentRoute */Config$ReasonScripts.urlToRoute(ReasonReact.Router[/* dangerouslyGetInitialUrl */3](/* () */0))];
            }),
                      ...
                      /* Sub */[
                        (function () {
                            return ReasonReact.Router[/* watchUrl */1]((function (url) {
                                          return Curry._1(send, /* ChangeUrl */[Config$ReasonScripts.urlToRoute(url)]);
                                        }));
                          }),
...
function make$1(route, className, children) {
  return /* record */[
          ...
          /* render */(function (self) {
              var href = Config$ReasonScripts.routeToString(route);
